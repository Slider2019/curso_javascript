...
/* **********     Curso JavaScript: 5. Cadenas de Texto (Strings) - #jonmircha     ********** */
    ...
    /*
        ...
        let nombre = "Diego";
        let apellido = 'Rojas';
        let saludo = new String("Esta es una nueva cadena");//Agregamos "new String" como una cadena
        ...
        console.log(
          nombre.length, //Propiedad .length (muestra la longitud total de una string)
          apellido.length,
          saludo.length,
          nombre.toUpperCase(), //Propiedad .toUpperCase (Muestra la cadena de texto de la variable nombre en mayusculas)
          apellido.toLowerCase(), //Propiedad .toLowerCase (Muestra la cadena de texto de la variable apellido en minusculas)
          lorem.includes("amet"), //Propiedad .includes (Mustra si el valor "amet" se encuentra dentro de la cadena "lorem")
